  ...
  return (
    <GlobalWrapper withLayout>
      ...
      <ProjectSection>
        ...
        <H3>NextJS</H3>
        <P>
          Next is a good framework for websites like this. It&apos;s easy, it
          has the pros of React and also additional features for static
          websites. I also used Gatsby for other website, but I can&apos;t say
          Next is better, because on Gatsby there is a better plugin ecosystem.
          <br />
        ...
        <P>
          ...
          like on React, if you don&apos;t use it, it will be difficult to copy
          all classes on objects. I wouldn&apos;t use it for a simple static
          website written directly on HTML and CSS.
          <br />
          It&apos;s very easy to write CSS code with classes like this, I think
          it&apos;s good for simple projects, but maybe it won&apos;t be good
          for important project with super-custom styling, which would need
          something like Styled Components.
        </P>
        <H3>Open Source</H3>
        <P>
        ...
        <P>
          ...
          framework created before SvelteKit, now it&apos;s not supported
          anymore. I think Svelte is super when you have to do something simple,
          or it&apos;s been useful also to replace jQuery from code, because is
          more simple than React, Angular or other frameworks.
          <br />I used Tailwind also here, nice, but I didn&apos;t use component
          logic, more difficult and more time-consuming approach, I didn&apos;t
          know which it was also possible on Svelte.
        </P>
        <Img
